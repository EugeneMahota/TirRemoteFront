...
export class ReportPersonComponent implements OnInit, OnDestroy {


  reportForm: FormGroup;
  listReport: ReportPerson[] = [];
  ...
  constructor(private breadService: BreadcrumbService,
    ...
    this.breadService.doOneBread('Отчет по работе операторов');
  }
  ...
  getReport(date) {
    ...
    if (this.reportForm.valid) {
      this.reportService.postPerson(reportDate).subscribe(res => {
        this.listReport = res;
      });
    } else {
